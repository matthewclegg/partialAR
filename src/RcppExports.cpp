...
static const R_CallMethodDef CallEntries[] = {
    {"_partialAR_lagged_variance_c", (DL_FUNC) &_partialAR_lagged_variance_c, 3},
    {"_partialAR_estimate_rho_par_c", (DL_FUNC) &_partialAR_estimate_rho_par_c, 1},
    {"_partialAR_estimate_par_c", (DL_FUNC) &_partialAR_estimate_par_c, 2},
    {"_partialAR_pvmr_par_c", (DL_FUNC) &_partialAR_pvmr_par_c, 3},
    {"_partialAR_kalman_gain_par_mr", (DL_FUNC) &_partialAR_kalman_gain_par_mr, 3},
    {"_partialAR_loglik_par_c", (DL_FUNC) &_partialAR_loglik_par_c, 6},
    {"_partialAR_loglik_par_t_c", (DL_FUNC) &_partialAR_loglik_par_t_c, 7},
    {NULL, NULL, 0}
};

RcppExport void R_init_partialAR(DllInfo *dll) {
